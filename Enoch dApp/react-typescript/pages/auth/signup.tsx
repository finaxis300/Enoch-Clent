            ...
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                country: Yup.string().required(
                  'Please  select the country, where you live in'
                ),
                ...
                dob: Yup.number().required('Please  enter your date of birth'),
                pass: Yup.string()
                  .min(2, 'Too Short!')
                  .max(500, 'Too Long!')
                  .required('Please create the password'),
                      ...
                      <div className='signup-check'>
                        <div>
                          <label className='signcheckbox-container'>
                            I want to receive the emails from Element Zero Dao
                            <input type='checkbox' />
