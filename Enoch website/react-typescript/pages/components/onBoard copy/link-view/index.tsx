...
const BoardingLinkView: React.FC = () => {
  return (
    <>
      <div id='Links' className='tabcontent'>
          ...
          {/* <!--
			                            <div className="dApp-post-comment-box">
			                                <div className="dApp-post-comment-writing-sect">
			                                    <div className="dApp-post-comment-input-sect">
			                                        <div className="dApp-post-commenter-img">
			                                            <img src="/images/write-comment-img.png" alt="dp" className="img-fluid" />
			                                        </div>
			                                    </div>
			                                    <div className="dApp-post-comment-input-fild">
			                                        <textarea name="" rows="1" id="" placeholder="Add a comment"></textarea>
			                                ...
			                                <div className="dApp-post-comment-sect">
			                                    <div className="dApp-post-commenter-img">
			                                        <img src="/images/commrnter-img.png" alt="dp" className="img-fluid" />
			                                    </div>
			                                    <div className="dApp-post-comment-right">
			                                        <div className="dApp-post-comment-text">
			                                            ...
			                                            <div className="dApp-post-3dots dropdown">
																<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/images/dApp-ThreeDots.png" alt="3dots" className="img-fluid post-threedots"/><img src="/images/ThreeDots-active.png" alt="3dots" className="img-fluid post-threedots-active"></a>
																<div className="dropdown-menu home-drop-postStatus">
																		<ul>
																			...
																			<li className="">
																				<a className="" href="#">
																					<div className="drop-postStatus-block">
																						...
																						<div className="drop-postStatus-block-right">
																							<h3>Report this post</h3>
																							<p>This comment is offensive or the account is hacked</p>
																						</div>
																					</div>
																				</a>
																			</li>
			                                        ...
			                                        <div className="dApp-post-comment-writing-sect">
			                                            <div className="dApp-post-comment-input-sect">
			                                                <div className="dApp-post-commenter-img">
			                                                    <img src="/images/comment-reply-dp.png" alt="dp" className="img-fluid" />
			                                                </div>
			                                            </div>
			                                            <div className="dApp-post-comment-input-fild">
			                                                <textarea name="" rows="1" id="" placeholder="Add a comment"></textarea>
...
export default BoardingLinkView
